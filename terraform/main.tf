...
# EBS Volume
resource "aws_ebs_volume" "crafty_data" { # Separate EBS volume being used to persist through termination of pods (if you'd like to increase the instance size for example)
